# ValidationTissue — Dependency Graph
## Tissue ID: TIS-VALIDATE-v0.1.0

### 1. Upstream Dependencies
| Dependency | Type | Required |
|-----------|------|----------|
| CEL-VALIDATOR | Cell | Yes |
| CEL-SCHEMASTORE | Cell | Yes |
| CEL-INVARIANTCHECK | Cell | Yes |
...
class ValidationTissueBinder {
  ...
  validateBindings(): BindingValidationResult {
    const required = ["CEL-VALIDATOR", "CEL-SCHEMASTORE", "CEL-INVARIANTCHECK"];
